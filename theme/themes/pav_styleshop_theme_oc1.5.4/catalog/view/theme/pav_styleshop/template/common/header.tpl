				...
				<div id="logo-theme"><a href="<?php echo $home; ?>"><span><?php echo $name; ?></span></a></div>
					...
					<div id="search">					
						<div class="input-group">
							<?php if ($filter_name) { ?>
							<input type="text" name="filter_name" value="<?php echo $filter_name; ?>" class="input-search form-control"/>
							<?php } else { ?>
							<input type="text" name="filter_name" value="<?php echo $text_search; ?>" onclick="this.value = '';" onkeydown="this.style.color = '#000000';" class="input-search form-control"/>
							<?php } ?>
